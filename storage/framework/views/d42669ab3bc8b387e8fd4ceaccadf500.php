    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="<?php echo e(route('invoices.index')); ?>">قائمة الفواتير</a></li>
                    <li><a class="slide-item" href="<?php echo e(route('Invoice_Paid')); ?>">الفواتير المدفوعة</a></li>
                    <li><a class="slide-item" href="<?php echo e(route('Invoice_UnPaid')); ?>">الفواتير الغير مدفوعة</a></li>
                    <li><a class="slide-item" href="<?php echo e(route('Invoice_Partial')); ?>">الفواتير المدفوعة جزئيا</a></li>
                    <li><a class="slide-item" href="<?php echo e(route('Archive.index')); ?>">الفواتير  المؤرشفة</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="<?php echo e(url('/'. $page="invoices_report")); ?>">تقارير الفواتير</a></li>
                    <li><a class="slide-item" href="<?php echo e(url('/' . $page='customers_report')); ?>">تقارير العملاء</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="<?php echo e(url('/' . $page='users')); ?>">قائمة المستخدمين</a></li>
                    <li><a class="slide-item" href="<?php echo e(url('/' . $page='roles')); ?>">صلاحيات المستخدمين</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="<?php echo e(route('sections.index')); ?>">الاقسام </a></li>
...
<!-- main-sidebar -->
<?php /**PATH C:\laragon\www\invoices\resources\views/layouts/main-sidebar.blade.php ENDPATH**/ ?>