                ...
                <div class="card-header pb-0">
                   ...
                   <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تصدير EXCEL')): ?>
                       <a class="modal-effect btn btn-sm btn-primary" href="<?php echo e(url('export_invoices')); ?>"
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تعديل الفاتورة')): ?>
                                                    <a class="dropdown-item"
                                                       href=" <?php echo e(url('edit_invoice')); ?>/<?php echo e($invoice->id); ?>">تعديل
                                                        الفاتورة</a>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('حذف الفاتورة')): ?>
                                                    <a class="dropdown-item" href="#" data-invoice_id="<?php echo e($invoice->id); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تغير حالة الدفع')): ?>
                                                    <a class="dropdown-item"
                                                       href="<?php echo e(URL::route('Status_show', [$invoice->id])); ?>"><i
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('طباعةالفاتورة')): ?>
                                                    <a class="dropdown-item" href="Print_invoice/<?php echo e($invoice->id); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\invoices\resources\views/invoices/invoices.blade.php ENDPATH**/ ?>