<!-- main-header opened -->
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">  عدد الاشعارات الغير مقروءة
                                            <?php echo e(auth()->user()->unreadNotifications->count()); ?></p>
									</div>
 ...
 <?php echo e($notification->data['title']); ?> <?php echo e($notification->data['user']); ?>
												...
												<div class="notification-subtext"><?php echo e($notification->created_at->format('H:i')); ?></div>
											</div>
                                            <div class="mr-auto" >
...
<!-- /main-header -->
<?php /**PATH C:\laragon\www\invoices\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>